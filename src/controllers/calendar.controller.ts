 ...
 * GET /api/calendars
 */
export const getUserCalendars = asyncHandler(
  async (req: Request, res: Response) => {
    const userId = req.userId!;
 ...
 */
export const getCalendarById = asyncHandler(
  async (req: Request, res: Response) => {
    const userId = req.userId!;
 ...
 */
export const setPrimaryCalendar = asyncHandler(
  async (req: Request, res: Response) => {
    const userId = req.userId!;
    const calendar = await calendarService.setPrimaryCalendar(
      req.params.id!,
      userId
    );
