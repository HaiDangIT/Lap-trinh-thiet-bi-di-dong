...
import { generateTwoFactorSecret, verifyTwoFactorToken, generateBackupCodes, hashBackupCode, verifyBackupCode, } from "../utils/twoFactor.util.js";
...
class TwoFactorService {
    ...
    async verifyTwoFactor(userId, token) {
        ...
        if (isValidBackup) {
            ...
            const updatedCodes = twoFactor.backupCodes.filter((code) => code !== hashBackupCode(token));
